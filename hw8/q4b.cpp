...
carefully logs data about his cows' locations, making a series of NN observations over the course of a single day. Each 
observation records the ID number of a cow (an integer in the range 1…101…10, since Farmer John has 10 cows), as well as 
